...
@Component({
  selector: 'app-home',
  imports: [RouterLink, MatCardModule, MatButtonModule, MatIconModule, TranslatePipe, LocalizedDatePipe, CurrencyFormatPipe, BookTableComponent, HasPermissionPipe],
